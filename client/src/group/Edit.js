...
class CEdit extends React.Component {
  ...
  render() {
    ...
    return (<div>
      ...
      <form ref={form => (this.formEl = form)} onSubmit={this.handleSubmit} noValidate="noValidate">
        {
          this.state.nameError && (<div className={classes.error}>
        ...
        <TextField id="name" name="name" label="Name" className={classes.textField} value={this.state.name} onChange={this.handleChange} margin="normal" variant="outlined" required={true}/>
